...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['idcolaborador'])) {
    ...
    $mes = $_POST['mes'] ?? null;
    $estado = $_POST['estado'] ?? null; // <--- Leer el nuevo parámetro estado
    $historico = obtenerHistoricoColaborador($_POST['idcolaborador'], $anio, $mes, $estado); // <--- Pasar estado a la función
