...
if (!isset($_SESSION['idusuario'])) {
    ...
    // Asumiendo que auth_check.php está en la raíz, y login.php también.
...
// Ejemplo: $current_user_type = $_SESSION['tipo_usuario'];
// Ejemplo: $current_user_emp_id = $_SESSION['idemp'];
?>
